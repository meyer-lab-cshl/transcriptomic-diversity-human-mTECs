...
dat <- read.table("/home/stroemic/hiwi_16/analysis/lars_perl/mouse_consensus_sites.csv", sep = ",")
...
write.table(dat_export, file ="/home/stroemic/hiwi_16/analysis/lars_perl/mouse_consensus_sites.bedgraph", row.names=FALSE, na="", col.names=FALSE, quote=FALSE, sep="\t")
