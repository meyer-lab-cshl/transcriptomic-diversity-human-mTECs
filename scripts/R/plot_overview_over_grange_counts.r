...
saveRDS(list_uncounted_pos, file = "/home/stroemic/hiwi_16/analysis/gene_lists/tra_san_aire_san_tss_high_count_list_uncounted_positions_human_filt.rds")
saveRDS(list_matrices, file="/home/stroemic/hiwi_16/analysis/gene_lists/tra_san_aire_san_tss_high_count_list_counts_matrices_human_filt.rds")
saveRDS(list_counts_classes, file="/home/stroemic/hiwi_16/analysis/gene_lists/tra_san_aire_san_tss_high_count_list_counts_classes_human_filt.rds")
...
for (i in c(250,1000,20000)) {
  ...
  pdf(file=paste("/home/stroemic/hiwi_16/analysis/gene_lists/plots/tra_san_aire_san_gene_range_analysis_",name,".pdf",sep=""))
  ...
  dev.off()
  pdf(file=paste("/home/stroemic/hiwi_16/analysis/gene_lists/plots/tra_san_aire_san_gene_range_analysis_line_",name,".pdf",sep=""))
  ...
  dev.off()
  pdf(file=paste("/home/stroemic/hiwi_16/analysis/gene_lists/plots/tra_san_aire_san_gene_range_analysis_line_only_",name,".pdf",sep=""))
