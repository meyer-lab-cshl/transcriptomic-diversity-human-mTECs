...
parser.add_option('--samfile', action="store", dest="samfile", type="string",
        nargs = 1)
parser.add_option('--out-renamed', action="store", dest="out_renamed",
...
for read in sam:
    ...
    if read.iv.chrom in ['gi|49175990_3526000-3530000',
            'gi|49175990_c66000-62000']:
