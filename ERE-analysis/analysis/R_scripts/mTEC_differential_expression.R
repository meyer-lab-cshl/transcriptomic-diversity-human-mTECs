...
functions = c('extract_subset', 'differential_expression', 'process_DESeq2_results', 'build_count_table', 'makeGRanges')
...
results_transcripts_ERE = extract_subset(mode = 'ERE', input = results_transcripts_TE)
