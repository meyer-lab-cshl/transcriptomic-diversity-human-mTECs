...
for (j in 1) {
  ...
  saveRDS(counts_mTECs, file=paste("/home/stroemic/hiwi_16/analysis/gene_lists/main_tss_new_classes_tss_oe_tra_san_aire_san_counts_mTECs_matrix_",class,".rds", sep=""))
  print("saved")
  ...
  saveRDS(counts_tissues, file=paste("/home/stroemic/hiwi_16/analysis/gene_lists/main_tss_new_classes_tss_oe_tra_san_aire_san_counts_tissues_matrix_",class,".rds", sep=""))
  print("saved")
  ...
  pdf(file =paste("/home/stroemic/hiwi_16/analysis/gene_lists/plots/main_tss_new_classes_tss_oe_tra_san_aire_san_absolut_positions_proportions_by_matrix_",class,".pdf", sep=""))
  ...
  pdf(file =paste("/home/stroemic/hiwi_16/analysis/gene_lists/plots/main_tss_new_classes_tss_oe_tra_san_aire_san_absolut_positions_percentage_by_matrix_",class,".pdf",sep=""))
