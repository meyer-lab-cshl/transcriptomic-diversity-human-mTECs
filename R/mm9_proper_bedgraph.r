...
for(i in files){
  ...
  dat_export <- data.frame("chrom"=dat$chromosome, "start"=dat$start, "end"=dat$end, "count"=dat$count)
  ...
  write.table(dat_export, file =paste("/home/stroemic/hiwi_16/data/Summary_counts/mouse/",name, ".bedgraph", sep=""), row.names=FALSE, na="", col.names=FALSE, quote=FALSE, sep="\t")
  print(paste("/home/stroemic/hiwi_16/data/Summary_counts/mouse/",name, ".bedgraph", sep=""))
