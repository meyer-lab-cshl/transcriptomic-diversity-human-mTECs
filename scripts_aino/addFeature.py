...
parser.add_option('-s', '--sam', action="store", dest="sam", type="string", nargs = 1)
parser.add_option('-i', '--info', action="store", dest="info", type="string", nargs = 1)
parser.add_option('-n', '--infoname', action="store", dest="infoname",choices = ['molecular_bc', 'chim_prox', 'common_seq', 'chim_dist', 'common_seq_2', 'pairing_type', 'p3_direction', 'p5_direction', 'confidence' ])
parser.add_option('-f', '--flagname', action="store", dest="flagname", type="string", nargs = 1)
#parser.add_option('-f', '--flagname', action="store", dest="flagname", type="int", nargs = 1)
#parser.add_option('-t', '--flagtype', action="store", dest = 'flagtype', choices = ['string', 'int', 'float']) # 
parser.add_option('-o', '--out', action="store", dest="out", type="string", nargs = 1)
...
counter = 0
#for read in HTSeq.SAM_Reader( sam ):
